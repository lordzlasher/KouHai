...
public class Video5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.lesson5));
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Video5Activity.this, R.style.BottomSheetDialogThemes);
                ...
                homeButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent;
                        intent = new Intent(Video5Activity.this, Home.class);
