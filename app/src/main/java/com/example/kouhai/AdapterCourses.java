...
public class AdapterCourses extends RecyclerView.Adapter<AdapterCourses.MyViewHolder> {
    ...
    //--> Constructor
    public AdapterCourses(ArrayList<Courses> myList) {
        this.myList = myList;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_courses_list,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.textView_email.setText(item.getDescription());
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView, OnRecyclerViewClickListener listener) {
            ...
            imageView_img = itemView.findViewById(R.id.id_image);
            textView_name = itemView.findViewById(R.id.id_name);
            textView_email = itemView.findViewById(R.id.id_description);
