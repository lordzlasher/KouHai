...
public class Video10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.lesson10));
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Video10Activity.this, R.style.BottomSheetDialogThemes);
                ...
                homeButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent;
                        intent = new Intent(Video10Activity.this, Home.class);
